...
`![Request to the application configuration endpoint](images/a02-01-request-config-endpoint.jpg.jpg)`
`![Response exposing security-question data](images/a02-02-response-exposed-config-data.jpg)`
